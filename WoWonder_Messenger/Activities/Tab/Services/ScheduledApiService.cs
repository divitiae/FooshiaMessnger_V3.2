...
namespace WoWonder.Activities.Tab.Services
{
    ...
    public class ScheduledApiService : Service
    {
        ...
        public override void OnCreate()
        {
            ...
            {
                base.OnCreate();
                PostUpdater = new PostUpdaterHelper(new Handler(), ResultSender);
        ...
        public override StartCommandResult OnStartCommand(Intent intent, StartCommandFlags flags, int startId)
        {
            ...
            try
            {
                ...
                if (PostUpdater != null)
                    ...
                    MainHandler.PostDelayed(new PostUpdaterHelper(new Handler(), ResultSender), AppSettings.RefreshChatActivitiesSeconds);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e.Message + " \n  " + e.StackTrace);
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                { 
                                    ...
                                    dbDatabase.Insert_Or_Update_LastUsersChat(Application.Context, ListUtils.UserList, SettingsPrefFragment.SChatHead);
                                    dbDatabase.Dispose();
                                }
                            }
                        }
                            ...
                            else
                            {
                               // Toast.MakeText(Application.Context, "ResultSender 1 \n", ToastLength.Short).Show();
                                ...
                                if (result.Users.Count > 0)
                                {
                                    ...
                                    //Insert All data users to database
                                    dbDatabase.Insert_Or_Update_LastUsersChat(Application.Context, ListUtils.UserChatList , SettingsPrefFragment.SChatHead);
                                    dbDatabase.Dispose();
