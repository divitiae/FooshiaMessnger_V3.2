...
namespace WoWonder.Activities.SettingsPreferences.General
{
    ...
    public class ManageSessionsActivity : AppCompatActivity, MaterialDialog.ISingleButtonCallback
    {
        ...
        private AdsGoogle.AdMobRewardedVideo RewardedVideo;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                StartApiService();
                RewardedVideo = AdsGoogle.Ad_RewardedVideo(this);
            }
            catch (Exception e)
            {
        ...
        private async Task LoadSessionsAsync()
        {
            if (Methods.CheckConnectivity())
            {
                ...
                (int apiStatus, var respond) = await RequestsAsync.Global.GetSessionsAsync();
