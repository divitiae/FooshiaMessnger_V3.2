...
{
    public class StickerFragment7 : Android.Support.V4.App.Fragment
    {
        ...
        public StickerFragment7(string type = "ChatWindowActivity")
        {
            Type = type;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            try
            {
                ...
                StickerAdapter = new StickerRecylerAdapter.StickerAdapter(Activity,Stickers.StickerList7);
