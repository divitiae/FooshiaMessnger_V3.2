...
{
    public class StickerFragment3 : Android.Support.V4.App.Fragment
    {
        ...
        public StickerFragment3(string type = "ChatWindowActivity")
        {
            Type = type;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            try
            {
                ...
                StickerAdapter = new StickerRecylerAdapter.StickerAdapter(Activity,Stickers.StickerList3);
