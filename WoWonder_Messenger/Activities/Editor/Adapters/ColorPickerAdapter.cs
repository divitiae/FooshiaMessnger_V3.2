    ...
    public class ColorPickerAdapter : RecyclerView.Adapter
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.color_picker_item_list, parent, false);
    ...
    public class ColorPickerAdapterViewHolder : RecyclerView.ViewHolder
    {
            ...
            Action<ColorPickerAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                ...
                ColorPickerView = MainView.FindViewById<ImageView>(Resource.Id.color_picker_view);
