...
#pragma warning restore 618
            ...
            {
                DisplayReportResultTrack(exception.Message + " \n  " + exception.StackTrace);
                return false;
            }
        }
        ...
        public static void SetFocusable(View v)
        {
            ...
            {
                DisplayReportResultTrack(e.Message + " \n  " + e.StackTrace);
            }
        }
        ...
        public static void DisplayAndHUDErrorResult(Activity activityContext, dynamic respond)
        {
            ...
            try
            {
                ...
                //Show a Error 
                AndHUD.Shared.ShowError(activityContext, errorText, MaskType.Clear, TimeSpan.FromSeconds(2));
            }
            catch (Exception exception)
            {
        ...
        public static void DisplayReportResultTrack(string message, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
        {
            try
            {
                System.Diagnostics.Trace.WriteLine("ReportMode >> message: " + message);
        ...
        public static class FunString
        {
            ...
            public static string DecodeString(string content)
            {
                try
                {
                    ...
                    text = tagWhiteSpaceRegex.Replace(text ?? throw new InvalidOperationException(""), "><");
        ...
        public static class AttachmentFiles
        {
            ...
            private static string GetDataColumn(Context context, Uri uri, string selection, string[] selectionArgs)
            {
                ...
                {
                   DisplayReportResultTrack(ex.Message + " \n  " + ex.StackTrace);
                }
                finally
                {
                    cursor?.Close();
...
#pragma warning restore 618
            ...
            public static string FolderDcimGif = FolderDcimMyApp + "/Gif/";
            public static string FolderDcimSticker = FolderDcimMyApp + "/Sticker/";
