...
using InterstitialAd = Android.Gms.Ads.InterstitialAd;
using IRewardedVideoAdListener = Android.Gms.Ads.Reward.IRewardedVideoAdListener;
...
namespace WoWonder.Helpers.Ads
{
    public static class AdsGoogle
    {
        ...
        private static Xamarin.Facebook.Ads.RewardedVideoAd RewardedVideoFb;
        private static Xamarin.Facebook.Ads.InterstitialAd InterstitialAdFb;
        ...
        public static void Ad_Interstitial(Activity context)
        {
            try
            {
                if (AppSettings.ShowAdMobInterstitial)
                {
                    ...
                    {
                        InterstitialAdFb = AdsFacebook.InitInterstitial(context);
                    }
        ...
        public static AdMobRewardedVideo Ad_RewardedVideo(Activity context)
        {
            try
            {
                if (AppSettings.ShowAdMobRewardVideo)
                {
                    ...
                    {
                        RewardedVideoFb = AdsFacebook.InitRewardVideo(context);
                    }
